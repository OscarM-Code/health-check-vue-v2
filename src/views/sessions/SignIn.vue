              ...
              <div class="grid grid-cols-12">
                  <div class="col-span-12 lg:col-span-6">
                      <div class="p-5">
                          ...
                          <form>
                              <div class="mb-3">
                                  <label class="text-xs text-gray-600" for="">Adresse mail</label>
                                  <input class="w-full px-4 py-1 bg-gray-100 focus:outline-none border border-gray-400 rounded-full" type="email" placeholder="" v-model="mail">
                              </div>
                              <div class="mb-3">
                                  <label class="text-xs text-gray-600" for="">Mot de passe</label>
                                  <input class="w-full px-4 py-1 bg-gray-100 focus:outline-none border border-gray-400 rounded-full" type="password" placeholder="" v-model="password">
                              </div>
                              <p v-if="!verif" class="text-red-500" >{{ errorMessage }}</p>
                              <div class="mb-4">      
                                  <BaseBtn block class="bg-green-500 mb-2 text-white  rounded-full" @click="login">Connexion</BaseBtn>
                              </div>
                          </form>
                      </div>
                  </div>
                  <div class="col-span-12 bg-cover lg:col-span-6" style="background-image: url(../../images/photo-long-3.jpg)">
                      <div class="flex justify-center items-center flex-col h-full px-4 py-2">
                          ...
                          <BaseBtn block rounded class="mb-3 border border-green-500 bg-gray-100 text-green-500 hover:bg-green-500 hover:text-white" @click="this.$router.push('/register')">
                            <i class="i-Mail-with-At-Sign align-middle mr-2"></i>Créer un compte
                          </BaseBtn>
                      </div>
                  </div>
              </div>
