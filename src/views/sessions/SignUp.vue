        ...
        <div class="grid grid-cols-12">
          ...
          >
            ...
            >
              ...
              >
                <i class="i-Mail-with-At-Sign align-middle mr-2"></i>Se
                connecter
              </BaseBtn>
            </div>
          </div>
          <div class="col-span-12 lg:col-span-6">
            <div class="p-5">
              ...
              <form>
                <div class="mb-3">
                  <label class="text-base text-gray-600" for=""
                    >Votre prénom</label
                  >
                  <input
                    class="
  ...
  methods: {
    register() {
      ...
      if (this.firstName && this.lastName && this.mail && this.password) {
        if (
          this.firstName.match(regexName) &&
          this.lastName.match(regexName) &&
          this.mail.match(regexMail)
        ) {
          ...
          this.toast("Veuillez entrer des données valides", "danger");
          this.validForm = false;
